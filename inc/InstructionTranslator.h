...
public:
	...
	* If any fixups are needed, litoffset and reloffset are set (explained below).
	* Otherwise litoffset and reloffset are set to -1.
	*/
	int getSize(Instruction* ins, int* litoffset, int* reloffset);
